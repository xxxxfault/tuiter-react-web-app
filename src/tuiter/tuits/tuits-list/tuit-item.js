                ...
                <div class="row">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row text-muted">
                            <div class="col-3"><i className="bi bi-chat"></i> {item.replies}</div>
                            <div class="col-3"><i className="bi bi-layer-forward"></i> {item.retuits}</div>
                            <div class="col-3"><i
                                className={`bi bi-suit-heart-fill text-secondary ${item.liked && "text-danger"}`}></i> {item.likes}
                            </div>
